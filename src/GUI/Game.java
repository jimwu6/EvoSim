...
public class Game extends JInternalFrame implements MouseListener, KeyListener, ActionListener, ChangeListener {
	...
	public void actionPerformed(ActionEvent e) {
        ...
        {
        	landscape.populate(new Amphibian("amphibian", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addCanine))
        {
        	landscape.populate(new Canine("canine", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addCellular))
        {
        	landscape.populate(new Cellular("cellular", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addFeline))
        {
        	landscape.populate(new Feline("feline", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addFish))
        {
        	landscape.populate(new Fish("fish", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addHooved))
        {
        	landscape.populate(new Hooved("hooved", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addLizard))
        {
        	landscape.populate(new Lizard("lizard", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addPrimate))
        {
        	landscape.populate(new Primate("primate", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addRaptor))
        {
        	landscape.populate(new Raptor("raptor", 1, 1, 10000, "male", true));
        }
        
        else if (e.getSource().equals(animalMenu.addRodent))
        {
        	landscape.populate(new Rodent("rodent", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addSmallBird))
        {
        	landscape.populate(new smallBird("smallBird", 1, 1, 10000, "male", true));
        }
        
        else if (e.getSource().equals(animalMenu.addSnake))
        {
        	landscape.populate(new Snake("snake", 1, 1, 10000, "male"));
        }
        
        else if (e.getSource().equals(animalMenu.addTurtle))
        {
        	landscape.populate(new Turtle("turtle", 1, 1, 10000, "male"));
        }
